...
export default function Training(props: Props) {
   return (
      <div className="w-full pc:h-1/3 mobile:h-1/5 flex items-center justify-center border border-black">
         <img src={props.thumbnail} alt="サムネイル" className="pc:w-1/4 mobile:w-1/3 px-3" />
